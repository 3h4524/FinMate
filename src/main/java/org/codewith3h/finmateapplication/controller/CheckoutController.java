...
public class CheckoutController {
    ...
    @PostMapping("/create")
    public ResponseEntity<ApiResponse<String>> createPaymentLink(@RequestParam String packageId) {
        String url = paymentService.createPaymentLink(Integer.parseInt(packageId));
