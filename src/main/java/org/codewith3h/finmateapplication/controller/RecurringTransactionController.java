...
public class RecurringTransactionController {
    ...
    public RedirectView confirmReminder(@RequestParam String token) {
        ...
        try {
            ...
            return new RedirectView("https://www.finmate.fun/pages/reminder-confirmed/?status=success");
        } catch (AppException ex) {
            String errorMessage = URLEncoder.encode(ex.getMessage(), StandardCharsets.UTF_8);
            return new RedirectView("https://www.finmate.fun/pages/reminder-confirmed/?status=error&message=" + errorMessage);
        }
    }
